...
class App:
    def __init__(self, master):
        ...
        # heading
        self.heading = Label(self.left, text="Enter patient details", font=('arial 18'), fg='black', bg='lightblue')
        ...
        #Date
        self.Date = Label(self.left, text="Date(dd/mm/yyyy)", font=('arial 12'), fg='black', bg='lightblue')
        self.Date.place(x=65, y=140)
        ...
        self.submit = Button(self.left, text="Back Home", width=20, height=2, bg='steelblue', command=root.destroy)
